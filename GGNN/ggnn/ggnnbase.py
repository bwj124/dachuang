    ...
    def train(self, is_test):
        ...
        with self.graph.as_default():
            ...
            if is_test == True:
                ...
                out_str = "%s\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%d\t%d\t%d\t%d"
                ...
                print('Test:', out_str%(self.params['valid_file'], valid_loss, valid_accs, valid_precision, valid_recall, valid_f1, valid_speed, valid_TP, valid_TN, valid_FP, valid_FN))
