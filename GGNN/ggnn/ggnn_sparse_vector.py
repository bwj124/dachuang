...
Options:
    ...
    --myalldata_dir          All data dir name.
...
class GGNNSparse(GGNN):
            ...
            with tf.variable_scope('gnn_layer_%i' % layer_idx):
                ...
                for step in range(num_timesteps):
                    with tf.variable_scope('timestep_%i' % step):
                        ...
                        node_states_per_layer[-1] = self.gnn_weights.rnn_cells[layer_idx](incoming_information, node_states_per_layer[-1])[1]  # Shape [V, D]
    ...
    def gated_regression(self, last_h, regression_gate, regression_transform):
        ...
        self.gated_outputs = gated_outputs
